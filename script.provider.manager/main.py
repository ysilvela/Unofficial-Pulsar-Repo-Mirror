...
TV_q1 = settings.getSetting('TV_q1')  # EZTV
TV_q2 = settings.getSetting('TV_q2')  # EZTV
movie_q1 = settings.getSetting('movie_q1')  # YIFY
movie_q2 = settings.getSetting('`movie_q2')  # YIFY
movie_q3 = settings.getSetting('`movie_q3')  # YIFY
...
dialog.ok('Changes are Done!!', 'All Installed have been Updated')